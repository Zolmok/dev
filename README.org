...
- Falls back to a sensible default 3-window layout (Claude-Code, Zsh, Server)
...
3. Default layout - Creates 3 windows (Claude-Code, Zsh, Server)
...
This generates a config with the default 3-window layout that you can customize. The session name is automatically set to the current directory name.
...
| Window | Name        | Purpose                    |
|--------+-------------+----------------------------|
|      0 | Claude-Code | Primary editing window     |
